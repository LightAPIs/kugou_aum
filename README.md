...
这是一个用于群晖 Audio Station 的歌词插件，歌词内容来源于[酷狗音乐](https://www.kugou.com/)。

## 下载插件

前往 [Releases](https://github.com/LightAPIs/kugou_aum/releases/latest) 下载插件压缩包 `zip` 文件并解压得到 `aum` 文件。
